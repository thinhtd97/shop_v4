...
export const userReviewReducer = (state = {}, action) => {
  switch (action.type) {
    case userConstants.USER_REVIEWS_REQUEST:
      return { loading: true }
    case userConstants.USER_REVIEWS_SUCCESS:
      return { loading: false, success: true }
    case userConstants.USER_REVIEWS_FAILED:
      return {
        loading: false,
        error: action.payload,
      }
    case userConstants.USER_REPLY_REVIEWS_REQUEST:
      return {
        loading: true,
      }
    case userConstants.USER_REPLY_REVIEWS_SUCCESS:
      return {
        loading: false,
        success: true,
      }
    case userConstants.USER_REPLY_REVIEWS_FAILED:
      return {
        loading: false,
        error: action.payload,
      }
